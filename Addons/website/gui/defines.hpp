...
// #define gc_GCWEBSITEFUNCTIONS_IDC_SENDBUTTON     33500
// #define gc_GCWEBSITEFUNCTIONS_IDC_CUSTOMCHATTEXT 33601

// #define gc_GCWEBSITEFUNCTIONS_UISIZESMALL        0.55
// #define gc_GCWEBSITEFUNCTIONS_UISCALE            ((getResolution select 5)/gc_GCWEBSITEFUNCTIONS_UISIZESMALL)

// #define gc_GCWEBSITEFUNCTIONS_SCALEFACTOR_Y      ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25)
// #define gc_GCWEBSITEFUNCTIONS_SCALESUMMAND_Y     (safezoneY)

// #define gc_GCWEBSITEFUNCTIONS_SCALEFACTOR_X      (((safezoneW / safezoneH) min 1.2) / 40)
// #define gc_GCWEBSITEFUNCTIONS_SCALESUMMAND_X     (safezoneX)

// #define gc_GCWEBSITEFUNCTIONS_SPACER_Y           (0.1 * gc_GCWEBSITEFUNCTIONS_SCALEFACTOR_Y)

// #define gc_GCWEBSITEFUNCTIONS_TITLE_Y            (1 * gc_GCWEBSITEFUNCTIONS_SCALEFACTOR_Y + gc_GCWEBSITEFUNCTIONS_SCALESUMMAND_Y)
// #define gc_GCWEBSITEFUNCTIONS_TITLE_X            ((65 ) *  gc_GCWEBSITEFUNCTIONS_SCALEFACTOR_X + gc_GCWEBSITEFUNCTIONS_SCALESUMMAND_X)

// #define gc_GCWEBSITEFUNCTIONS_ELEMENT_H          (1 * gc_GCWEBSITEFUNCTIONS_SCALEFACTOR_Y)
// #define gc_GCWEBSITEFUNCTIONS_TOTAL_W            (15 * gc_GCWEBSITEFUNCTIONS_SCALEFACTOR_X)

// #define gc_GCWEBSITEFUNCTIONS_EDITBOX_BG_Y       (gc_GCWEBSITEFUNCTIONS_TITLE_Y + gc_GCWEBSITEFUNCTIONS_ELEMENT_H + gc_GCWEBSITEFUNCTIONS_SPACER_Y)
// #define gc_GCWEBSITEFUNCTIONS_EDITBOX_BG_H       ((8 * gc_GCWEBSITEFUNCTIONS_ELEMENT_H) / gc_GCWEBSITEFUNCTIONS_UISCALE)

// #define gc_GCWEBSITEFUNCTIONS_EDITBOX_PADDING_Y  ((0.5 * gc_GCWEBSITEFUNCTIONS_ELEMENT_H) / gc_GCWEBSITEFUNCTIONS_UISCALE)
// #define gc_GCWEBSITEFUNCTIONS_EDITBOX_H          (gc_GCWEBSITEFUNCTIONS_EDITBOX_BG_H - 2 * gc_GCWEBSITEFUNCTIONS_EDITBOX_PADDING_Y)
// #define gc_GCWEBSITEFUNCTIONS_EDITBOX_Y          (gc_GCWEBSITEFUNCTIONS_EDITBOX_BG_Y + gc_GCWEBSITEFUNCTIONS_EDITBOX_PADDING_Y)

// #define gc_GCWEBSITEFUNCTIONS_EDITBOX_PADDING_X  (0.5 * (((safezoneW / safezoneH) min 1.2) / 40))
// #define gc_GCWEBSITEFUNCTIONS_EDITBOX_X          (gc_GCWEBSITEFUNCTIONS_TITLE_X + gc_GCWEBSITEFUNCTIONS_EDITBOX_PADDING_X)
// #define gc_GCWEBSITEFUNCTIONS_EDITBOX_W          (gc_GCWEBSITEFUNCTIONS_TOTAL_W - 2 * gc_GCWEBSITEFUNCTIONS_EDITBOX_PADDING_X)

// #define gc_GCWEBSITEFUNCTIONS_SENDBUTTON_Y       (gc_GCWEBSITEFUNCTIONS_EDITBOX_BG_Y + gc_GCWEBSITEFUNCTIONS_EDITBOX_BG_H + gc_GCWEBSITEFUNCTIONS_SPACER_Y)
// #define gc_GCWEBSITEFUNCTIONS_SENDBUTTON_Y_2     (gc_GCWEBSITEFUNCTIONS_EDITBOX_BG_Y + gc_GCWEBSITEFUNCTIONS_EDITBOX_BG_H + 2*gc_GCWEBSITEFUNCTIONS_SPACER_Y + gc_GCWEBSITEFUNCTIONS_ELEMENT_H)
...
#define gc_GCWEBSITEFUNCTIONS_ELEMENT_H          (1 * gc_GCWEBSITEFUNCTIONS_SCALEFACTOR_Y)
#define gc_GCWEBSITEFUNCTIONS_TOTAL_W            (15 * gc_GCWEBSITEFUNCTIONS_SCALEFACTOR_X)
#define gc_GCWEBSITEFUNCTIONS_TITLE_X            (GUI_GRID_TOPRIGHT_X + 24 * GUI_GRID_W)
...
//reviews
#define gc_GCWEBSITEFUNCTIONS_IDC_SUBMIT_REVIEW_SENDBUTTON     33500
#define gc_GCWEBSITEFUNCTIONS_SUBMIT_REVIEW_TITLE_Y            (1 * gc_GCWEBSITEFUNCTIONS_SCALEFACTOR_Y + gc_GCWEBSITEFUNCTIONS_SCALESUMMAND_Y)
#define gc_GCWEBSITEFUNCTIONS_SUBMIT_REVIEW_EDITBOX_BG_Y       (gc_GCWEBSITEFUNCTIONS_SUBMIT_REVIEW_TITLE_Y + gc_GCWEBSITEFUNCTIONS_ELEMENT_H + gc_GCWEBSITEFUNCTIONS_SPACER_Y)
#define gc_GCWEBSITEFUNCTIONS_SUBMIT_REVIEW_SENDBUTTON_Y       (gc_GCWEBSITEFUNCTIONS_SUBMIT_REVIEW_EDITBOX_BG_Y + gc_GCWEBSITEFUNCTIONS_EDITBOX_BG_H + gc_GCWEBSITEFUNCTIONS_SPACER_Y)
#define gc_GCWEBSITEFUNCTIONS_SUBMIT_REVIEW_EDITBOX_Y          (gc_GCWEBSITEFUNCTIONS_SUBMIT_REVIEW_EDITBOX_BG_Y + gc_GCWEBSITEFUNCTIONS_EDITBOX_PADDING_Y)

///ratings
#define gc_GCWEBSITEFUNCTIONS_IDC_SUBMIT_RATING_SENDBUTTON     33501
#define gc_GCWEBSITEFUNCTIONS_SUBMIT_RATING_TITLE_Y           (gc_GCWEBSITEFUNCTIONS_SUBMIT_REVIEW_SENDBUTTON_Y + gc_GCWEBSITEFUNCTIONS_ELEMENT_H + gc_GCWEBSITEFUNCTIONS_EDITBOX_PADDING_Y)
#define gc_GCWEBSITEFUNCTIONS_SUBMIT_RATING_COMBO_Y     	  (gc_GCWEBSITEFUNCTIONS_SUBMIT_RATING_TITLE_Y + gc_GCWEBSITEFUNCTIONS_ELEMENT_H + gc_GCWEBSITEFUNCTIONS_SPACER_Y)
#define gc_GCWEBSITEFUNCTIONS_SUBMIT_RATING_SENDBUTTON_Y      (gc_GCWEBSITEFUNCTIONS_SUBMIT_RATING_COMBO_Y + gc_GCWEBSITEFUNCTIONS_ELEMENT_H + gc_GCWEBSITEFUNCTIONS_SPACER_Y)

///bug reports
#define gc_GCWEBSITEFUNCTIONS_IDC_SUBMIT_BUGREPORT_SENDBUTTON     33502
#define gc_GCWEBSITEFUNCTIONS_SUBMIT_BUGREPORT_TITLE_Y           (gc_GCWEBSITEFUNCTIONS_SUBMIT_RATING_SENDBUTTON_Y + gc_GCWEBSITEFUNCTIONS_ELEMENT_H + gc_GCWEBSITEFUNCTIONS_EDITBOX_PADDING_Y)
#define gc_GCWEBSITEFUNCTIONS_SUBMIT_BUGREPORT_EDITBOX_BG_Y      (gc_GCWEBSITEFUNCTIONS_SUBMIT_BUGREPORT_TITLE_Y + gc_GCWEBSITEFUNCTIONS_ELEMENT_H + gc_GCWEBSITEFUNCTIONS_SPACER_Y)
#define gc_GCWEBSITEFUNCTIONS_SUBMIT_BUGREPORT_SENDBUTTON_Y      (gc_GCWEBSITEFUNCTIONS_SUBMIT_BUGREPORT_EDITBOX_BG_Y + gc_GCWEBSITEFUNCTIONS_EDITBOX_BG_H + gc_GCWEBSITEFUNCTIONS_SPACER_Y)
#define gc_GCWEBSITEFUNCTIONS_SUBMIT_BUGREPORT_EDITBOX_Y         (gc_GCWEBSITEFUNCTIONS_SUBMIT_BUGREPORT_EDITBOX_BG_Y + gc_GCWEBSITEFUNCTIONS_EDITBOX_PADDING_Y)
